...
from db import User, Task, Event, File, db_session, Base, engine
...
if __name__ == '__main__':
    Base.metadata.create_all(engine)  # Создание таблиц с помощью SQLAlchemy
    main()